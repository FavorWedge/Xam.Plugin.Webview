...
namespace SampleApp
{
    ...
    {
        private ObservableCollection<SelectionItem> Items = new ObservableCollection<SelectionItem>();
        ...
        private void AddItems()
        {
            ...
            {
                Identifier = 23,
                Title = "Smart Content Builder test",
                Detail = "Alchemy Smart Content Builder web view"
            });
            ...
            Items.Add(new SelectionItem()
            {
                ...
                Title = "Local Files",
                Detail =
                    "Load local files, by default these are Android Assets, iOS Resources, and files in the root of a UWP solution"
            });
            ...
            Items.Add(new SelectionItem()
            {
                ...
                Detail =
                    "Test bindable properties CanGoForward and CanGoBack, as well as the GoBack and GoForward functions"
            });
            ...
            {
                Identifier = 22,
                Title = "Content Player test",
                Detail = "Alchemy Content Player with global callbacks in the web view"
            });
        }

        private async void ItemSelected(object sender, SelectedItemChangedEventArgs e)
        {
            var i = (e.SelectedItem as SelectionItem)?.Identifier;
            ...
            switch (i)
            {
                ...
                case 22:
                    await ((NavigationPage) Application.Current.MainPage).PushAsync(new ContentPlayerSample());
                    break;

                case 23:
                    await ((NavigationPage) Application.Current.MainPage).PushAsync(new SmartContentBuilderSample());
                    break;
            }
        }
    }
