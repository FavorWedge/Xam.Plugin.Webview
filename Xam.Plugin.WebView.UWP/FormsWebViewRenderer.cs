...
namespace Xam.Plugin.WebView.UWP
{
    public class FormsWebViewRenderer : ViewRenderer<FormsWebView, Windows.UI.Xaml.Controls.WebView>
    {
        ...
        void SetupControl()
        {
            ...
            Control.PermissionRequested += ControlOnPermissionRequested;

            OnControlChanged?.Invoke(this, control);
        }

        private void ControlOnPermissionRequested(Windows.UI.Xaml.Controls.WebView sender, WebViewPermissionRequestedEventArgs args)
        {
        ...
        void OnNavigationCompleted(Windows.UI.Xaml.Controls.WebView sender, WebViewNavigationCompletedEventArgs args)
        {
            ...
            if (!args.IsSuccess)
            {
                Element.HandleNavigationError((int) args.WebErrorStatus, true);
                return;
            }
