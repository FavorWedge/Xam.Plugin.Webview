    ...
    public class FormsWebViewRenderer : ViewRenderer<FormsWebView, WKWebView>, IWKScriptMessageHandler, IWKUIDelegate
    {
        ...
        void SetupControl()
        {
            ...
            if (UIDevice.CurrentDevice.CheckSystemVersion(10, 0))
                _configuration.MediaTypesRequiringUserActionForPlayback = WKAudiovisualMediaTypes.None;
            else
                _configuration.MediaPlaybackRequiresUserAction = false;
        ...
        public void RunJavaScriptAlertPanel(WebKit.WKWebView webView, string message, WKFrameInfo frame,
        ...
        public void RunJavaScriptConfirmPanel(WKWebView webView, string message, WKFrameInfo frame,
        ...
        public void RunJavaScriptTextInputPanel(WKWebView webView, string prompt, string defaultText,
            WebKit.WKFrameInfo frame, System.Action<string> completionHandler)
        {
